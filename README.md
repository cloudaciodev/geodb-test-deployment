...
```
cd existing_repo
git remote add origin https://gitlab.com/cloudacio/spacialdb/test_services.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cloudacio/spacialdb/test_services/-/settings/integrations)
